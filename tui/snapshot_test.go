...
func TestRenderSnapshot(t *testing.T) {
	...
	jobs := []cron.Job{
		{ID: "launchd-user:com.foo.alpha", Kind: cron.KindLaunchd, Name: "com.foo.alpha", Schedule: "every 5m", Status: "running"},
		{ID: "launchd-user:com.foo.beta", Kind: cron.KindLaunchd, Name: "com.foo.beta", Schedule: "at load", Status: "loaded"},
		{ID: "launchd-user:com.foo.gamma", Kind: cron.KindLaunchd, Name: "com.foo.gamma", Schedule: "31 0 * * 0", Status: "exited 1"},
		{ID: "crontab:abcd1234", Kind: cron.KindCrontab, Name: "backup.sh", Schedule: "@daily", Status: "scheduled"},
	}
